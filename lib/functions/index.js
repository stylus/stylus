...
/**
 * Get value with given precision.
 *
 * @param {Unit} val
...
exports.precise = function precise(val, precision){
  utils.assertType(val, 'unit', 'val');
  utils.assertType(precision, 'number', 'precision');
  return new nodes.Unit(val.val.toFixed(precision), val.type);
};
