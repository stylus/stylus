...
(exports.s = function(fmt){
  ...
  // format
  str = str.replace(/%(s)/g, function(_, specifier){
    var arg = args[i++] || nodes.null;
    switch (specifier) {
      case 's':
        return arg.toLiteralString();
    }
  });
...
(exports['add-property'] = function(name, expr){
