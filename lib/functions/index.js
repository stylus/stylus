...
/**
 * Gets root selector in current nesting tree.
 *
 *  * Example:
 *
 *    .foo
...
/**
 * Rewinds current selector on i steps.
 *
 * * Example:
 *
 *    .foo
 *      &__bar
 *        &:hover
 *          & + {up(1)} // 1 is default, can be omitted
 *           // => .foo__bar:hover + .foo__bar
 *           
 * @param {Number} i
 * @return {String}
 * @api public
...
/**
 * Gets the last element in the current nesting route.
 *
 * * Example:
 *
 *    .foo
