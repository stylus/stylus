...
(exports['opposite-position'] = function(positions){
  ...
  positions.nodes.forEach(function(pos, i){
    ...
    switch (pos.string) {
      case 'top': expr.push(new nodes.Ident('bottom')); break;
      case 'bottom': expr.push(new nodes.Ident('top')); break;
      case 'left': expr.push(new nodes.Ident('right')); break;
      case 'right': expr.push(new nodes.Ident('left')); break;
