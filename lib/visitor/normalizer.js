 ...
 * compiler, it is tasked with stripping the "garbage"
 * from the evaluated nodes, ditching null rules, resolving
...
Normalizer.prototype.visitGroup = function(group){
  ...
  if (group.block.hasProperties) {
    ...
    // extensions
    group.extends.forEach(function(selector){
      var groups = map[selector];
      // TODO: clone() nodes for linenos etc
      if (!groups) throw new Error('Failed to @extend "' + selector + '"');
      selectors.forEach(function(selector){
