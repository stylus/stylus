...
Evaluator.prototype.visitImport = function(imported){
  ...
  if (~path.indexOf('.css') && !~path.indexOf('.css.')) {
    literal = true;
    if (!this.includeCSS) return imported;
  }
  ...
  found = found || utils.find(join(name, 'index.styl'), this.paths, this.filename);
  ...
  found.forEach(function (file) {
    block.push(importFile.call(this, imported, file, literal));
  }, this);
