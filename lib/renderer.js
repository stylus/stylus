...
/**
 * Require a given library as a plugin
 * that extends the current Renderer instance
 * via the plugin constructor passed given options.
 *
 * @param {String} plugin library to require
 * @param {Object} (optional) options to pass to plugin
 * @return {Renderer} for chaining
 * @api public
 */

Renderer.prototype.plugin = function(lib, options){
  require(lib)(this, options);
  return this;
};
