...
function Lexer(str, options) {
  ...
  function comment(str, val, offset, s) {
    ...
    var prevLineCommentStart = s.lastIndexOf('//', offset);
    var inLineComment = prevLineCommentStart >= 0 && prevLineCommentStart >= prevNewLine;

    var prevBlockCommentStart = s.lastIndexOf('/*', offset);
    var prevBlockCommentEnd =   s.lastIndexOf('*/', offset);
    var inBlockComment = prevBlockCommentStart > prevBlockCommentEnd;
