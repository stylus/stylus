...
var Parser = exports = module.exports = function Parser(str, options) {
  options = options || {};
  this.str = str;
...
Parser.prototype = {
  ...
  get selector() {
    var selector = this.expect('selector');
    return new nodes.Selector(selector.val, this.block);
  },
